...
public class WillowToolMaterials {
    ...
    // NOTE: mining speed can't be 1.0 or lower, or efficiency won't have any effect
    public static final ToolMaterial SLEDGEHAMMER = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, 600, 1.1f, 0.0f, 6, WillowTags.Items.SLEDGEHAMMER_TOOL_MATERIALS);
