...
public class WillowToolMaterials {
    ...
    public static final ToolMaterial SLEDGEHAMMER = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, 250, 1.1f, 0.0f, 6, WillowTags.Items.SLEDGEHAMMER_TOOL_MATERIALS);
